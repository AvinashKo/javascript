...
describe('decode ways checks', () => {
  ...
  describe('decode ways functionality checks', () => {
    ...
    it('should handle leading zeros', () => {
      expect(decodeWays.decodeWays('0111')).toEqual(0);
    });
    ...
    it('should handle trailing zeros', () => {
      expect(decodeWays.decodeWays('230')).toEqual(0);
    });
    ...
    it('should handle larger string', () => {
      expect(decodeWays.decodeWays('1111111111')).toEqual(89);
      expect(decodeWays.decodeWays('111111111111111111111111111111111111111111111')).toEqual(1836311903);
    });
  });
});
